"""
LLaMA specific attention hooks.

Compatible with transformers >= 4.40.0 and LLaMA3 models.
"""
...
def hooked_eager_attention_forward(
    ...
    **kwargs,
    ...
    """
    Modified eager attention forward with hook support for LLaMA.
    """
    # Repeat KV for GQA
...
def create_hooked_forward(original_forward, attention_hook: AttentionHook):
    """
    Create a hooked version of LlamaAttention.forward that uses our custom attention.
    """
    def hooked_forward(
        self,
...
class LlamaHookManager(HookManager):
    """
    Hook manager for LLaMA models (LLaMA2, LLaMA3).
    """
    ...
    def _setup_hooks(self):
        """Register hooks with LLaMA attention layers."""
...
class LlamaMaskingHookManager(LlamaHookManager):
    """LLaMA hook manager specifically for masking experiments."""
    ...
    def _setup_hooks(self):
        """Register masking hooks with LLaMA attention layers."""
        num_layers = self._get_num_layers()
